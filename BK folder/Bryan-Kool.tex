...
$$
Then each $\Y_k \subset S \times T$ is $T$-flat as well. The maximal CM subschemes $\Y_{k, \CM} \subset \Y_k \subset S \times T$ are $T$-flat as well \todo{I can provide explanation why $\Y_{\CM,k}$ also $T$-flat. Needed?} and induces morphisms
\begin{align*}
