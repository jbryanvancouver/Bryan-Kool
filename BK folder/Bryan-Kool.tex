...
\begin{itemize}
\item $p$ has a \emph{unique} section $B \hookrightarrow S$,\todo{Drop uniqueness so generating function becomes product with contribution from multiple sections?}
