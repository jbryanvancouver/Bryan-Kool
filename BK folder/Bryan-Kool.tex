...
The authors are like to thank Paul Johnson, Oliver Leigh, Davesh Maulik, 
Georg Oberdieck, Rahul Pandharipande, Bal\'azs Szendr\H{o}i, 
Richard Thomas, and Benjamin Young for helpful conversations. 
...
Finally, since the $\CC^*$-invariant Cohen-Macaulay curves 
just described are exactly the support curves of PCP curves, 
it follows that the PCP locus is $\CC^*$-invariant.
\end{proof}
