...
%there is indeed 
%$$
%f : \Hilb^0(X,B+nF) \rightarrow \Hilb^0(nF).
%$$
%Also, for a choice of section $B \subset X$, taking scheme theoretic union gives a closed embedding
%$$
%g : \Hilb^0(X,nF) \rightarrow \Hilb^0(B+nF).
%$$
%and clearly $f \circ g = 1$, showing the first map is surjective. Maybe the first map is a fibre bundle with fibre $H^0()$
