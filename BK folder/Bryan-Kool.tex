...
\emptyset}}q^{|\mu |} \right).
\end{align*}
Applying slight rearrangements of \cite[eqns~(2)\&(4)]{Bryan-Kool-Young} we see that 
\begin{align*}
...
The above accounts for exactly $2|\lambda |$ different equivalence
classes of Haiman arrows to $\lambda F$-cubes. However, $\lambda_{1}$
of these arrows have their head a $B$-cube, namely the southeast
...
of $d$ which in this case (because $\length (Z_{\lambda}\cap B)=l$)
have $\lambda_{1}=l$.
