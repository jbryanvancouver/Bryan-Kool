...
\emph{fpqc descent} \cite[Tag 023T, Prop.~34.5.2]{stacks-project} (or
...
Cohen-Macaulay curve. This follows from $\nu([Z]) = (-1)^{T_H|_P}$,
where $T_H|_P$ is the tangent space to $H = \Hilb(Y)$ at $P = [Z]$
\cite[Thm.~3.4]{Behrend-Fantechi08}, and the calculation of this parity in
\cite[Sect.~4.10]{MNOP1}.
