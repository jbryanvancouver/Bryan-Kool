...
\emptyset}}{\Vsf_{\lambda \emptyset \emptyset}}& = p^{-\half}
...
vertex ops are skew schur}, and finally equation~\eqref{eqn: ORV formula for vertex}:
\begin{align*}
...
&=p^{-\half }M(p) \sum_{\lambda} q^{|\lambda |} \left(\sum_{i=1}^{\infty}
